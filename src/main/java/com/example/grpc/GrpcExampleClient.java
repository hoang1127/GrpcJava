...
public class GrpcExampleClient {
    public static void main(String [] args) throws IOException, InterruptedException {
        ...
        final AtomicReference<StreamObserver<BiDirectionalExampleService.RequestCall>> requestObserverRef = new AtomicReference<StreamObserver<BiDirectionalExampleService.RequestCall>>();
